import { NXQLReindexDataResolver } from './nxql-reindex-data.resolver';
...
import { NXQLTabComponent } from "../sub-features/generic-multi-feature-layout/components/nxql-tab/nxql-tab.component";
