...
export const ADMIN_MENU: AdminMenu[] = [
    ...
    { id: 3, name: 'Elastic Search Reindex', path: "admin-elastic-search-reindex", isSelected: false },
    { id: 4, name: 'Fulltext Reindex', path: "admin-fulltext-reindex", isSelected: false },
    { id: 5, name: 'Thumbnail Generation', path: "admin-thumbnail-generation", isSelected: false },
